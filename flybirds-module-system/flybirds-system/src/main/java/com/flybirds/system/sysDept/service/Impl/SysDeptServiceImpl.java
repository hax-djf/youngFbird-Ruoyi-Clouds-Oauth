package com.flybirds.system.sysDept.service.Impl;

import cn.hutool.core.collection.CollUtil;
import com.baomidou.mybatisplus.extension.service.impl.ServiceImpl;
import com.flybirds.api.core.entity.SysDept;
...
import com.flybirds.system.sysDept.mapper.SysDeptMapper;
...
import static com.flybirds.common.exception.enums.SysErrorCodeConstants.DEPT_NOT_ENABLE;
import static com.flybirds.common.exception.enums.SysErrorCodeConstants.DEPT_NOT_FOUND;
...
public class SysDeptServiceImpl extends ServiceImpl<SysDeptMapper,SysDept> implements ISysDeptService
{
    ...
    public int insertDept(SysDept dept)
    {
        ...
        AssertUtil.isTrue(!Constant.User.DEPT_NORMAL.equals(info.getStatus()),new CustomException("部门停用，不允许新增"));
    ...
    public int updateDept(SysDept dept)
    {
        ...
        if (Constant.User.DEPT_NORMAL.equals(dept.getStatus()))
        {
    ...
    {
        String updateName = dept.getUpdateName();
        Long updateUser = dept.getUpdateUser();
        dept = deptMapper.selectDeptById(dept.getDeptId());
        dept.setUpdateName(updateName);
