package com.flybirds.system.sysDept.controller;
...
@RestController
@RequestMapping("/dept")
public class SysDeptController extends MpBaseController
{
    @Autowired
    ...
    {
        if (Constant.User.NOT_UNIQUE.equals(deptService.checkDeptNameUnique(dept)))
        {
    ...
    public AjaxResult edit(@Validated @RequestBody SysDept dept)
    {
        ...
        else if (StringUtils.equals(Constant.User.DEPT_DISABLE, dept.getStatus())
