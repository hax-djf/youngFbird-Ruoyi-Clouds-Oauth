...
import com.flybirds.excel.utils.easyexcel.convert.JsonConvert;
import lombok.Data;
...
public class SysSmsLogExcelVO {
    ...
    @DictFormat(DictTypeConstant.USER_TYPE)
    private Integer userType;

    @ExcelProperty(value = "发送状态", converter = DictConvert.class)
    @DictFormat(DictTypeConstant.SMS_SEND_STATUS)
    ...
    @DictFormat(DictTypeConstant.SMS_RECEIVE_STATUS)
