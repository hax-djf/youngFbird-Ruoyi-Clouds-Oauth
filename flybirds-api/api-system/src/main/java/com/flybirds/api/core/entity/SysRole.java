...
public class SysRole extends TenantBaseEntity
{
    ...
    /** 角色ID */
    @ExcelPOI(name = "角色序号", cellType = ColumnType.NUMERIC)
    ...
    @ExcelPOI(name = "数据范围", readConverterExp = "1=所有数据权限,2=自定义数据权限,3=本部门数据权限,4=本部门及以下数据权限")
    ...
    /** 角色状态（0正常 1停用） */
    @ExcelPOI(name = "角色状态", readConverterExp = "0=正常,1=停用")
