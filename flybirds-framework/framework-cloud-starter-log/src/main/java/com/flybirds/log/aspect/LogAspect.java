package com.flybirds.log.aspect;
...
import com.flybirds.log.enums.BusinessStatus;
import com.flybirds.log.service.AsyncLogService;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.flybirds.log.annotation.Log)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try
        {
            log.info("进入 log拦截的线程名称 {}",Thread.currentThread().getName());
