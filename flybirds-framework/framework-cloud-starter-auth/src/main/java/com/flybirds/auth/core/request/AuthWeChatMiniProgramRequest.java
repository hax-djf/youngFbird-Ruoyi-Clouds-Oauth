package com.flybirds.auth.core.request;

import com.fasterxml.jackson.annotation.JsonProperty;
import com.flybirds.auth.core.enums.AuthExtendSource;
import com.flybirds.auth.core.model.AuthExtendToken;
...
public class AuthWeChatMiniProgramRequest extends AuthDefaultRequest {
    ...
    protected AuthToken getAccessToken(AuthCallback authCallback) {
        ...
        CodeSessionResponse accessTokenObject = JsonUtil.parseObject(response, CodeSessionResponse.class);
