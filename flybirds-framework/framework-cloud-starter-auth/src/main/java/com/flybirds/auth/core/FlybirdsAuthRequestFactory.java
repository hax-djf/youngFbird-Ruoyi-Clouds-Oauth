package com.flybirds.auth.core;

import cn.hutool.core.util.EnumUtil;
import cn.hutool.core.util.ReflectUtil;
import com.flybirds.auth.core.enums.AuthExtendSource;
import com.flybirds.auth.core.request.AuthWeChatMiniProgramRequest;
 ...
 */
// TODO @timfruit：单测
public class FlybirdsAuthRequestFactory extends AuthRequestFactory {
    ...
    public FlybirdsAuthRequestFactory(JustAuthProperties properties, AuthStateCache authStateCache) {
