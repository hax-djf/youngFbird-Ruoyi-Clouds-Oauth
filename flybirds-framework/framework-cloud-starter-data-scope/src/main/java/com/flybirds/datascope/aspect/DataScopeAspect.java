package com.flybirds.datascope.aspect;
...
public class DataScopeAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.flybirds.datascope.annotation.DataScope)")
    ...
    public static void dataScopeFilter(JoinPoint joinPoint, SysUser user, String deptAlias, String userAlias)
    {
        ...
        if (StringUtils.isNotBlank(sqlString.toString()))
        {
            ...
            if (StringUtils.isNotNull(params) && params instanceof MpBaseEntity)
            {
                MpBaseEntity baseEntity = (MpBaseEntity) params;
