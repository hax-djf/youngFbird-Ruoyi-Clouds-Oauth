...
public class WebHttpUtils {
     ...
     */
    public static SortedMap<String, Object> getAllParams(XssRequestWrapper request) throws Exception {
     ...
     */
    public static Map<String, Object> getAllRequestParam(final XssRequestWrapper request) throws Exception {
        //上传文件
     ...
     * @author show
     */
    public static Map<String, Object> getUrlParams(final XssRequestWrapper request) {
