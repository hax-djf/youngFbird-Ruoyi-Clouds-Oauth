package com.flybirds.smsprovider.client.impl.yunpian;
...
public class YunpianSmsClient extends AbstractSmsClient {
    ...
    @VisibleForTesting
    <T, R> SmsResult<R> invoke(Supplier<Result<T>> requestConsumer, Function<T, R> responseConsumer) throws Throwable {
        // 执行请求
        ...
        // 拼接结果
        return SmsResult.build(String.valueOf(result.getCode()), formatResultMsg(result), null, data, codeMapping);
    }
