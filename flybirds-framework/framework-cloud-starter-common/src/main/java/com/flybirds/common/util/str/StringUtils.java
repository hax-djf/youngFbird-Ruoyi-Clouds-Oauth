package com.flybirds.common.util.str;

import com.flybirds.common.core.text.StrFormatter;
import java.util.*;
...
public class StringUtils extends org.apache.commons.lang3.StringUtils
{
    ...
    public static  boolean isMobile(String mobile){
        ...
        return CHINA_PATTERN.matcher(mobile).matches() || HK_PATTERN.matcher(mobile).matches();
    ...
    public static boolean isNumeric(String number) {
        ...
        return NUM_PATTERN.matcher(number).matches();
    }
