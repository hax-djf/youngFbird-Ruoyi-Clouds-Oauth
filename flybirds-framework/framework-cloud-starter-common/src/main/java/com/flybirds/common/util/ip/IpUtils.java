...
import com.flybirds.common.util.html.EscapeUtil;
...
{
    /* oauth 传递的用户ip地址 */
    public static String getOauthUserIpAddr(HttpServletRequest request)
    {
        if (request == null)
        {
            return "unknown";
        }
        String ip = request.getHeader(SecurityConstant.USER_IP);
