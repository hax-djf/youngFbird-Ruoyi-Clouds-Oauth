package com.flybirds.common.exception.enums;
...
public interface SysErrorCodeConstants {
    ...
    ErrorCode AUTH_THIRD_LOGIN_BIND_FAIL = new ErrorCode(1002000006, "第三方账号绑定失败");
    ErrorCode AUTH_TOKEN_EXPIRED = new ErrorCode(401, "身份认证失败或者失效，请重新登录");
    ErrorCode AUTH_NOT_PERMISSIONS = new ErrorCode(403, "权限不足，请联系管理员");
    ErrorCode AUTH_LOGIN_USER_PASS_NOT_NULL = new ErrorCode(1002000008, "用户/密码必须填写");
    ErrorCode AUTH_LOGIN_PASS_NOT_SCOPE = new ErrorCode(1002000009, "用户密码不在指定范围");
    ErrorCode AUTH_LOGIN_USER_NOT_SCOPE= new ErrorCode(1002000010, "用户名不在指定范围");
    ErrorCode AUTH_LOGIN_MOBILE_NOT_NULL= new ErrorCode(1002000011, "手机号必须填写");
    ErrorCode AUTH_LOGIN_MOBILE_FAIL= new ErrorCode(1002000012, "用户手机格式不正确");
    ErrorCode AUTH_LOGIN_CAPTCHA_CODE_NOT_NULL = new ErrorCode(1002000013, "验证码必填");
    ErrorCode AUTH_LOGIN_CAPTCHA_CODE_FAIL= new ErrorCode(1002000014, "验证码格式错误");
    ErrorCode AUTH_LOGIN_CAPTCHA_CODE_NOT_FOUND = new ErrorCode(1002000015, "验证码不存在/失效");
    ErrorCode AUTH_LOGIN_CAPTCHA_CODE_ERROR = new ErrorCode(1002000016, "验证码不正确");
    ErrorCode AUTH_LOGIN_SOCIAL_CODE_NOT_NULL = new ErrorCode(1002000016, "social code is  null");
    ErrorCode AUTH_LOGIN_SOCIAL_STATE_NOT_NULL = new ErrorCode(1002000016, "social state is  null");
    ErrorCode AUTH_LOGIN_SOCIAL_TYPE_NOT_NULL = new ErrorCode(1002000016, "social授权类型 type is  null");
